...
public class CustomerDAOImpl implements CustomerDAO {
	...
	private final String SQL_GET_CUSTOMERBYID = "SELECT id, firstName, lastName, email FROM customer WHERE id = ?";
	...
	public Customer getCustomer(int theId) {
		...
		return jdbcTemplate.queryForObject(SQL_GET_CUSTOMERBYID, rowMapper, theId);
	}
	...
	public void updateCustomer(Customer theCustomer) {
		jdbcTemplate.update(SQL_UPDATE_CUSTOMER, theCustomer.getFirstName(), theCustomer.getLastName(),
				theCustomer.getEmail(), theCustomer.getId());
		// Object[] params = { theCustomer.getFirstName(), theCustomer.getLastName(),
		// theCustomer.getEmail(),
		// theCustomer.getId() };
		// jdbcTemplate.update(SQL_UPDATE_CUSTOMER, params);
	}
